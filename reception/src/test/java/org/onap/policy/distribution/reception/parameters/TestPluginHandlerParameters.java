...
public class TestPluginHandlerParameters {
    ...
    public void testValidate_PolicyDecodersEmpty() {
        PluginHandlerParameters emptyDecoder =
                new PluginHandlerParameters(new HashMap<String, PolicyDecoderParameters>(), getPolicyForwarders());
    ...
    public void testValidate_PolicyForwardersNullEmpty() {
        PluginHandlerParameters emptyDecoder =
                new PluginHandlerParameters(getPolicyDecoders(), new HashMap<String, PolicyForwarderParameters>());
