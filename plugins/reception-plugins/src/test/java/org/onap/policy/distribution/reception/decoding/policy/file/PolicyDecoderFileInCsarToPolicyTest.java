...
import org.onap.policy.distribution.reception.decoding.policy.file.PolicyDecoderFileInCsarToPolicy;
...
public class PolicyDecoderFileInCsarToPolicyTest {
    ...
    public void testDecodePolicyError() throws IOException {
        ...
        try {
            ...
            assertTrue(exp.getMessage().contains("Failed decoding apex policy"));
        }
    }
}
