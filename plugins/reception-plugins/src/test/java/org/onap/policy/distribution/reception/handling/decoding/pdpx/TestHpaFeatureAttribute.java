...
public class TestHpaFeatureAttribute {
    ...
    public void testHpaFeatureAttribute() {
        ...
        hpaFeatureAttribute.setHpa_attribute_value(hpaAttributeValue);
    ...
    private void validateReport(final String hpaAttributeKey, final String hpaAttributeValue, final String operator,
        ...
        assertEquals(hpaAttributeKey, hpaFeatureAttribute.getHpa_attribute_key());
        assertEquals(hpaAttributeValue, hpaFeatureAttribute.getHpa_attribute_value());
