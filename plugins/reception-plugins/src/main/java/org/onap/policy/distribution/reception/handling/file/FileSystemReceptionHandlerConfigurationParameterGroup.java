...
public class FileSystemReceptionHandlerConfigurationParameterGroup extends ReceptionHandlerConfigurationParameterGroup {
     ...
     */
    private void validatePathElement(final BeanValidationResult validationResult, final String element,
        ...
        if (!valid) {
            validationResult.addResult(elementName, element, ValidationStatus.INVALID, "is not a valid directory");
        }
    }
}
