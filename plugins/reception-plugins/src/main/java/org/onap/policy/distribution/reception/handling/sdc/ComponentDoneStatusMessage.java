...
public class ComponentDoneStatusMessage implements IComponentDoneStatusMessage {
     ...
     * @param distributionStatusEnum the distribution status
     * @param timestamp the status time
     * @param consumerId the consumer id
     */
    public ComponentDoneStatusMessage(final String distributionId, final DistributionStatusEnum distributionStatusEnum,
            final long timestamp, final String consumerId) {
